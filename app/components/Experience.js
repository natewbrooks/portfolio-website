		...
		<section
			...
			<div className='flex flex-col justify-center items-center h-full w-full'>
				<p className='mb-20 text-md md:text-xl text-zinc-200 break-words px-8 md:mx-20 lg:mx-40'>
					&nbsp;&nbsp;&nbsp;&nbsp; I’m a 21 year old software engineering student with 8+ years of
					programming experience. It all started when I began creating Java Minecraft plugins around 10
					...
					down the line I can say "I can build anything" with absolute confidence. Getting closer with every new project.
				</p>
